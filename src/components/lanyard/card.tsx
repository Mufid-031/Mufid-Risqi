...
function Band({ maxSpeed = 50, minSpeed = 10 }) {
  const band: any = useRef(null), fixed: any = useRef(null), j1: any = useRef(null), j2: any = useRef(null), j3: any = useRef(null), card: any = useRef(null) // prettier-ignore
